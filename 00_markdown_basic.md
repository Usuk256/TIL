...
> 헤더는 제목을 표현할 때 사용합니다. 단순히 글자의 크기를 ㅛㅍ현하는 것이 아닌 의미론적인 중요도를 나타냅니다.
...
- 로컬에 이미파일을 저앟나 경우 절대 경로가 아닌 상대 경로를 사용하여 이미지를 저장합니다.

![이미지](C:\Users\HPE\Downloads\1_mtsk3fQ_BRemFidhkel3dA.png)
...
- 보드체는 해당 부분을 `**`혹은 `__`(언터바 2개)로 감싸줍니다.
